...
window.Modernizr = (function( window, document, undefined ) {
    ...
    //
    // The following results are known incorreContC:
    ...
    function webforms() {
        ...
        // Both tests are available in feature-deteContC/forms-placeholder.js
            ...
            for ( var i = 0, bool, inputElemType, defaultView, len = props.length; i < len; i++ ) {
                ...
                if ( bool ) {
                    ...
                    if ( /^range$/.test(inputElemType) && inputElem.style.WebkitAppearance !== undefined ) {
                      ...
                      // If the upgraded input compontent rejeContC the :) text, we got a winner
      ...
      function shivDocument(ownerDocument) {
        ...
        if (html5.shivCSS && !supportsHtml5Styles && !data.hasCSS) {
          data.hasCSS = !!addStyleSheet(ownerDocument,
            // correContC block display not defined in IE6/7/8/9
    ...
    /*>>hasevent*/
    // Modernizr.hasEvent() deteContC support for a given event, with an optional element to test on
